...
const BudgetEdit=(()=>{
 ...
 const rows=[...t.items.map(r=>[r.code+' / '+r.name,r.amount]),['Overhead',t.oh],['Laba',t.profit],['Pajak',t.tax]],targets=OfferDocument.amounts(t.total,terms),remaining=targets.values.slice();let left=t.total,cumulative=0;
...
if(typeof document!=='undefined')(()=>{
 ...
 const fields=[['code','Kode'],['name','Uraian'],['category','Kategori'],['qty','Volume','number'],['unit','Satuan'],['price','Harga satuan','number'],['manualAmount','Jumlah manual (kosong = otomatis)','number'],['supplier','Pemasok'],['specification','Spesifikasi'],['basis','Dasar volume / catatan'],['status','Status'],['supplier_contact','Kontak'],['price_basis','Dasar harga'],['kg_per_unit','kg per satuan','number']];
